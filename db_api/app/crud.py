...
class Conversation:
    ...
    def get_conversations(self, user_id: int):
        return self.db.query(models.Conversation).filter(models.Conversation.user_id == user_id).all()

    def get_conversation(self, conversation_id: int, user_id: int):
        return self.db.query(models.Conversation).filter(models.Conversation.id == conversation_id, models.Conversation.user_id == user_id).first()
